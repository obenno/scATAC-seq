...
chrom_assay <- CreateChromatinAssay(
  ...
  min.cells = as.numeric(params$minCell),
  min.features = as.numeric(params$minFeature)
)
...
scATAC_obj$orig.ident <- params$sampleName
...
tribble(
  ...
  "Valid barcodes", scales::label_percent()(as.numeric(readReport$validBarcode_ratio)),
...
fig <- plot_ly(data = d, x = ~idx, y = ~counts, type = 'scatter', mode = 'lines',
