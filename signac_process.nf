process SIGNAC {
    ...
    signac_process.R -f $fragment \\
                     ...
                     --nCount_max ${params.nCountMax} \\
                     --FRiP_cutoff ${params.FRiP_cutoff} \\
                     --blacklist_fraction_cutoff ${params.blacklist_fraction_cutoff} \\
                     --nucleosome_signal_cutoff ${params.nucleosome_signal_cutoff} \\
                     --TSS_enrichment_cutoff ${params.TSS_enrichment_cutoff} \\
